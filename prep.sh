...
cp $i.forML.gz  ~tfry2/block_model/forML.gz

## egh.forML.gz has been used to create blocks (see 
ls ~tfry2/block_model/compute.sh


#then it the blocks are run and the acf machines and results put on
/da4_data/play/idres
